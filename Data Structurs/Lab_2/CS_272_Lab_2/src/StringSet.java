...
public class StringSet 
{
	...
	public boolean remove(String a)
	{
		...
		if(this.contains(a))
			for(int i = 0; i < this.numberOfAuthors - 1; i++)
				if(this.authors[i].equals(a))
				{
					for(int j = i; j < this.numberOfAuthors - 1; j++)
						this.authors[j] = new String(this.authors[j + 1]);
	...
	public static void main(String args[])
	{
		...
		System.out.println("Adding \"a\" to the s2 StringSet object");
		s2.add("a");
		System.out.println("Adding \"b\" to the s2 StringSet object");
		s2.add("b");
		System.out.println("Adding \"c\" to the s2 StringSet object");
		s2.add("c");
		System.out.println("Adding \"d\" to the s2 StringSet object");
		s2.add("d");
		System.out.println("Adding \"e\" to the s2 StringSet object");
		s2.add("e");
		
		System.out.println("Removing \"c\" from s2 StringSet object");
		s2.remove("c");
		
		//testing size and capacity functions
		System.out.println("The current size of s2 is: " + s2.size() + " the current capacity of s2 is: " + s2.capacity());
	}
}
