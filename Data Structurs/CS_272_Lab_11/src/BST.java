...
public class BST {
	 ...
	 * @return
	 * True if element is inserted, false if element is not inserted or is already apart of the tree.
	 */
	 ...
	 * @return
	 * The node that contains the element or null is element dose not exist.
	 */
	public BSTNode searchRecursion(int e)
	{
		...
		if(e < root.getData())
			return this.getLeftSubtree().searchRecursion(e);
		
		if(e > root.getData())
			return this.getRightSubtree().searchRecursion(e);
	...
	/**
	 * Non-recursive method to search for element in the tree.
	 * @param e
	 * Element to search for
	 * @return
	 * Returns the node that contains the element or null if the tree does not contain the element.
	 */
	public BSTNode searchNonRecursion(int e)
	{
		BST cursor = this;
		
		while( cursor.root != null)
		{
			if( cursor.root.getData() == e)
				return cursor.root;
			else if(e > cursor.root.getData())
				cursor = cursor.root.getRight();
			else if (e < cursor.root.getData())
	...
	/**
	 * Recursive method to sum all the elements in the tree.
	 * @return
	 * The total sum of all the elements in the tree.
	 */
	public int sum()
	{
		if(root == null)
